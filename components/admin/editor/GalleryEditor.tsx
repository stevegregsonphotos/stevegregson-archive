    ...
    >
      ...
      >
        <div>
          ...
          >
            Reorder photographs, change layouts, remove images,
            or select a new hero.
          </p>
        </div>
      ...
      {images.length === 0 ? (
        ...
        >
          This production has no gallery images.
        </p>
      ) : (
        <div
          style={{
            ...
            return (
              ...
              >
                ...
                >
                  ...
                  >
                    <img
                      src={`/images/productions/${productionSlug}/${image.src}`}
                      alt={image.alt}
                      loading="lazy"
                      style={{
                        display: "block",
                ...
                <div style={{ padding: "1rem" }}>
                  ...
                  >
                    {isSelectedHero
                      ? "Selected as new hero"
                      : "Click image to select hero"}
                  </p>
